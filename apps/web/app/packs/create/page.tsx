    ...
    >
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <section className="mb-8">
          <h1 className="mb-1 text-3xl font-extrabold text-white">إنشاء باقة أسئلة جديدة</h1>
          <p className="text-slate-400">أضف أسئلتك يدوياً أو استخدم الذكاء الاصطناعي لتوليدها تلقائياً</p>
        </section>

        <PackCreatorClient userId={session.user.id} />
      </main>
